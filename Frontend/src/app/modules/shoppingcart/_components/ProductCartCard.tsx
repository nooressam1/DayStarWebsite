...
const ProductCartCard = ({ name, price, photo, size, quantity, variant_id, onIncrement, onDecrement, onRemove }: CartItemCardProps) => {
  const displayImage =
  ...
  return (
    <div className="flex flex-row w-full items-center justify-between">
      <div className="flex flex-row gap-5 w-1/2 items-center">
      ...
      <div className="flex flex-row gap-2 items-center justify-center w-1/4">
        <div className="pl-4">
