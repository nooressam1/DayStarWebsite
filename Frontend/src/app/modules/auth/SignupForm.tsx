...
export default function SignupForm({ onSwitch, onSuccess }: SignupFormProps) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="text-center text-sm text-brand-gray font-sans">
        ...
        <button
          onClick={onSwitch}
          className="text-brand-primary-brown underline font-medium hover:text-brand-light-brown transition-colors"
        >
          Sign in
        </button>
      </p>
